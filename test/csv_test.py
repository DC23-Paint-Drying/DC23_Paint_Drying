...
def test_empty_packets_list():
    columns = ["id", "packets"]
    client = {"id": "01", "packets": []}
    ...
    db1.drop_database()
def test_non_empty_packets_list():
    columns = ["id", "packets"]
    client = {"id": "01", "packets": ['a','b']}
    ...
    db1.drop_database()
def test_get_all_clients_with_list():
    columns = ["id", "packets"]
    client1 = {"id": "01", "packets": []}
    client2 = {"id": "02", "packets": ['a']}
    client3 = {"id": "03", "packets": ['b','c','d']}
    db = CSVDatabase("dbtest.csv", columns)
