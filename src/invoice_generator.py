...
def generate_invoice_xml(client_data: Dict, date: datetime.datetime | None = None, indent: str = "    ") -> str:
    """
    ...
    ET.SubElement(payment, "due").text = str(datetime.datetime(year=date.year, month=date.month+1, day=1).date())
